...
export default function addMedicationScreen() {
    ...
    const validateForm = () => {
      ...
      const handleSave = async () => {
        try {
            if(!validateForm()){
                Alert.alert("Error", "Please fill in all required fieds correctly");
                return;
            }
                ...
                contentContainerStyle={styles.formContentContainer}>
                            ...
                            <View style={styles.switchRow}>
                                <View style={styles.switchLabelContainer}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.switchSubLabel}>Get notified when its time to get your medications</Text>
                                    </View>
                                </View>
                                <Switch
                    ...
                    <View style={styles.section}>
                        <View style={styles.textAreaContainer}>
                            ...
                            placeholder="Add notes of special instructions..."
                            placeholderTextColor="#999"
                            value={form.notes}
